...
// // console.log(`user id from maincontent line 123 ======`,userId)
...
//   return (
//     <div className="w-full md:w-3/4 p-4 bg-white dark:bg-gray-900">
//       <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white border-b pb-5">News Articles:</h2>
...
//       ) : posts.length > 0 ? (
//         posts.map((post) => (
//           <div key={post._id} className="mb-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow">
//             {post.image && (
//               <img
//                 src={post.image}
//                 alt={post.title}
